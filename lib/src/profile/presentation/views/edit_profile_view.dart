...
import 'package:clean_arch_bloc_2/core/common/widgets/nested_back_button.dart';
...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  void initState() {
    ...
    // putting already existing user details in place.
    // see we are taking this already existing data from userProvider.
    // and then after calling the update method we are getting data from bloc
    //
    super.initState();
  }
    ...
    return BlocConsumer<AuthBloc, AuthState>(
      listener: (context, state) {
        if (state is UserUpdated) {
          ...
          // if I had to show updated new user data on this screen itself
          // after update is finished here.
          // then we would have to wrap this widget also in
          // Consumer<UserProvider> to listen to changes from
          // userProvider
          // and then after update done, here we had to call the setter:
          // context.read().user = newUser.
          // so new user data will be updated locally and consumer will
          // listen to those changes and reflect it here on this screen.
